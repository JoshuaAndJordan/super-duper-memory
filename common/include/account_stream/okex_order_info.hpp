...
#ifdef CRYPTOLOG_USING_MSGPACK
    MSGPACK_DEFINE(instrumentType, instrumentID, currency, orderID,
                   orderPrice, quantityPurchased, orderType, orderSide,
                   positionSide, tradeMode, lastFilledQuantity,
                   lastFilledFee, lastFilledCurrency, state, feeCurrency,
                   fee, updatedTime, createdTime, amendResult,
                   amendErrorMessage, forAliasedAccount);
#endif
  };
