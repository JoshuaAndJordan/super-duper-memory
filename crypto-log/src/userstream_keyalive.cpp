...
userstream_keyalive_t::userstream_keyalive_t(net::io_context &io_context,
                                             net::ssl::context &ssl_context,
                                             std::string listen_key,
                                             std::string api_key)
    : m_ioContext(io_context), m_sslContext(ssl_context),
      m_listenKey(std::move(listen_key)), m_apiKey(std::move(api_key)) {}
...
void userstream_keyalive_t::prepare_request() {
  ...
  request.set(field::user_agent, "PostmanRuntime/7.32.2");
